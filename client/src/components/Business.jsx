  ...
  <section id="features" className={layout.section}>
    <div className={layout.sectionInfo}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        expensetracker helps you stay on top of your financial goals with category-wise budgeting, smart alerts, and seamless syncing. Take charge of your spending—every rupee matters.
      </p>
